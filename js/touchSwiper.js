var Swiper = function (selector, params) {
    ...
    _this.init = function (force, forceCalcSlides) {
        ...
        if (params.slidesPerView === 'auto') {
            ...
            if (isH) {
                ...
                wrapperSize = _this.wrapperTop + _this.wrapperBottom;
    ...
    _this.createPagination = function (firstInit) {
        ...
        if (params.createPagination) {
            ...
            for (var i = 0; i < numOfButtons; i++) {
				$(_this.paginationContainer).children().eq(i).addClass(params.paginationElementClass);
    ...
    function removePaginationEvents() {
        ...
        for (var i = 0; i < pagers.length; i++) {
            _this.h.removeEventListener(pagers[i].childNodes[0], 'click', paginationClick);
        }
    }
    ...
    function addPaginationEvents() {
        var pagers = _this.paginationButtons;
        for (var i = 0; i < pagers.length; i++) {
            _this.h.addEventListener(pagers[i].childNodes[0], 'click', paginationClick);
        }
    }
    ...
    function paginationClick(e) {
        ...
        var pagers = _this.paginationButtons;
        for (var i = 0; i < pagers.length; i++) {
            if (target === pagers[i].childNodes[0] || target === pagers[i].childNodes[0].childNodes[0]) index = i;
        }
        _this.swipeTo(index);
		e.preventDefault();
    }
